...
import com.example.foodproj.Presentation.Repository.Retrofit.RetrofitBuilder;
import com.example.foodproj.Presentation.Repository.Retrofit.RetrofitInterface;
...
public class ConverterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {Ф
            @Override
